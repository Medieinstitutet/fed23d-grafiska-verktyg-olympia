export const Recipes = [
  {
    ...
    ingredients: [
      '1 cup sourdough starter, 1½ cups warm water, 3½ cups bread flour, 2 tsp salt, ¼ tsp active dry yeast (optional, for a boost), Cornmeal for dusting ',
    ],
    instructions:
  ...
  },
  {
    ...
    ingredients: [
      '2¾ cups all-purpose flour, 1 tsp sugar, 2 tsp salt, 1 tbsp fresh rosemary, chopped, 1 packet instant yeast, 1 cup warm water, ¼ cup olive oil (plus more for drizzling)',
    ],
    instructions:
  ...
  },
  {
    ...
    ingredients: [
      '2 cups whole wheat flour, 1 cup all-purpose flour, ¼ cup honey, 1 packet instant yeast, 1½ cups warm water, 1 tsp salt',
    ],
    instructions:
  ...
  },
  {
    ...
    ingredients: [
      '4 cups bread flour, 1 tbsp sugar, 2 tsp salt, 1 packet instant yeast, 1¼ cups warm water, 1 tbsp malt syrup or honey (for boiling water), Poppy seeds or sesame seeds for topping',
    ],
    instructions:
  ...
  },
  {
    ...
    title: 'Baguettes',
    ingredients: [
      '4 cups bread flour, 1½ tsp salt, 1 tsp sugar, 1 packet active dry yeast, 1⅓ cups warm water, Cornmeal for dusting',
    ],
    instructions:
  ...
  },
  {
    ...
    ingredients: [
      '3 cups all-purpose flour, 1 packet active dry yeast, 1 cup warm milk, ¼ cup sugar, 1 tsp salt, 1 cup raisins, 2 tsp ground cinnamon',
    ],
    instructions:
